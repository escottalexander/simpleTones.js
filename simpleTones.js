...
//Tone Storage
const TONE_OLD = {
	'C0': 16.35,'C#0': 17.32,'D0': 18.35,'D#0': 19.45,'E0': 20.60,'F0': 21.83,'F#0': 23.12,'Gb0': 23.12,'G0': 24.50,'G#0': 25.96,'A0': 27.50,'A#0': 29.14,'B0': 30.87,
	...
	'C8': 4186.01,'C#8': 4435,'D8': 4699,'D#8': 4978,'E8': 5274,'F8': 5588,'F#8': 5920,'G8': 6272,'G#8': 6645,'A8': 7040,'A#8': 7459,'B8': 7902
}
...
const playSingleFrequency = (frequency = 440, type = 'sine', duration = 1.3) => {
...
// window.start.addEventListener('click', init ,false)
